...
export function Menu() {
  return (
    <nav className="flex items-center space-x-6 text-gray-500">
      <Logo />
      <Link className="font-semibold hover:text-gray-100" href="/">
        Home
      </Link>
      <Link className="font-semibold hover:text-gray-100" href="/products">
        Farol
      </Link>
      <Link className="font-semibold hover:text-gray-100" href="/lanternas">
        Lanterna
      </Link>
      ...
      <Link className="font-semibold hover:text-gray-100" href="/sobre">
        Sobre
      </Link>
      <SearchDropdown />
