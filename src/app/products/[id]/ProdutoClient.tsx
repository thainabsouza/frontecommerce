      ...
      <div className="grid md:grid-cols-2 gap-8 bg-white rounded-2xl shadow p-6">
        ...
        <div className="flex flex-col justify-between">
          ...
          <div className="flex gap-4">
            <button className="flex-1 bg-yellow-500 cursor-pointer hover:bg-yellow-600 text-white py-3 rounded-lg font-bold transition">
              Comprar Agora
            </button>
            <button onClick={() => addToCart(product)}
             className="flex-1 bg-black cursor-pointer font-bold hover:bg-gray-600 text-white py-3 rounded-lg transition">
